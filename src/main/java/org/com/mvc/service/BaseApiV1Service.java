...
public interface BaseApiV1Service<T>{
	
	T find(ApiV1DTO apiV1DTO)throws Exception;
	
	
	Object selectOne(ApiV1DTO apiV1DTO)throws Exception;
	
	List<?> select(ApiV1DTO apiV1DTO)throws Exception;
